...
const Smartgarden = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 p-8 h-screen relative">
      <Joyride
        steps={steps}
        run={run}
        continuous
      ...
      <div className="flex flex-row gap-2 items-center justify-center mt-4 ">
        <div className="max-w-sm  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-3">
            ...
            <a
              href="#"
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:r ing-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Predict Now!
            </a>
          </div>
