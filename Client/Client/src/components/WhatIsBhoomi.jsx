...
const WhatIsBhoomi = () => {
  ...
  return (
    <div className="p-0 bg-gradient-to-b from-green-100 via-green-200 to-green-400  ">
      ...
      <br />
      {/* Explanation */}
      <h1 className="text-4xl font-bold mb-6 ml-2 flex-row transition-all duration-150 hover:text-blue-500">
      What is Bhoomi?
    </h1>
      <div>
      <p className="text-lg mb-4 ml-2 transition-opacity duration-300 hover:opacity-75">
      Bhoomi is a revolutionary web application designed to assist farmers like you in making informed decisions about soil health and crop selection. Our goal is to empower you with the tools and knowledge needed to optimize your agricultural practices for sustainability and productivity.
    </p>
      </div>
      <div>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4 ml-2 transition-all duration-300 hover:text-blue-500">
      How Does Bhoomi Work?
    </h2>
      <p className="text-lg mb-4 ml-2">
        <span className="font-bold">Soil Nutrient Analysis:</span> Bhoomi utilizes advanced machine learning
        ...
        <br />
        <span className="font-bold">Crop Recommendation:</span> Based on the analysis of your soil's nutrient
        ...
        <br />
        <span className="font-bold">Sustainable Farming Practices:</span> In addition to crop recommendations,
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4 ml-3">
